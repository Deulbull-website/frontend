    ...
    <div className="mx-auto w-full max-w-[430px] bg-[#0a0a0c] text-white">
      ...
      <div className="flex flex-col gap-3.5 px-6 pt-6">
        ...
        <ul className="flex list-disc flex-col gap-2.5 pl-[18px]">
          {NOTICES.map((n, i) => (
            <li key={i} className="whitespace-pre-line text-[13px] leading-[1.75] text-white/82">
              {n}
            </li>
          ))}
        </ul>
...
const NOTICES = [
  ...
  <>대면 오디션 안내는 모집 마감 후 9/7까지 기입해 주신 연락처로<br />카카오톡을 통해 개별 안내드릴 예정입니다.</>,
  '9/7까지 오디션 관련 안내를 받지 못하셨을 경우, 들불 인스타그램 DM(@hs_deulbull) 또는 홈페이지로 문의해 주시기 바랍니다.',
  '연주 영상 제출은 필수가 아니지만, 미제출 시 선발 과정에서\n불이익이 발생할 수 있습니다.',
  '지원자가 많을 경우, 신청서 및 연주 영상을 바탕으로 1차 선발 후 \n합격자에 한해 2차 대면 오디션을 진행할 예정입니다.',
  '오디션 현장에는 마이크, 앰프, 건반, 드럼 및 스틱, 기타, 베이스, \n케이블 등이 준비되어 있으며 MR 사용 및 개인 악기 지참도 가능합니다.',
  '악기나 밴드 경험이 전혀 없는 분들도 환영하며 적극 선발하고 있습니다.',
  '모든 문의 사항은 인스타그램(@hs_deulbull) DM 또는 홈페이지 문의를 이용해 주시기 바랍니다.',
];
